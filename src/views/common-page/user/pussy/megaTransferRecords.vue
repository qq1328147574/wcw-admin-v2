    ...
    >
      <div v-for="(item, index) in orderList" :key="index">
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">OrderId</div>
          <div class="v-value">{{ item.OrderId }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">Account</div>
          <div class="v-value">{{ item.Account }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">UserName</div>
          <div class="v-value">{{ item.UserName }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">ActionIP</div>
          <div class="v-value">{{ item.ActionIP }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">Action_Type</div>
          <div class="v-value">{{ item.Action_Type }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">AfterNum</div>
          <div class="v-value">{{ item.AfterNum }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">ScoreNum</div>
          <div class="v-value text-red">{{ item.ScoreNum }}</div>
        </div>
        <div class="v-list-item flex align-center justify-between">
          <div class="v-label">时间</div>
          <div class="v-value text-red">{{ item.C_DateTime }}</div>
        </div>
      </div>
...
import { pussyQueryUserScoreLog } from "@/api";
...
export default class Name extends Vue {
  ...
  async getBetOrder() {
    const { data } = await pussyQueryUserScoreLog({...this.params, userId: this.userId});
